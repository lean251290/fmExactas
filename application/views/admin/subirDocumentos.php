...
<div class="container">
  ...
  <div class="container col-lg-4">
    <form action="<?php echo base_url('Documentos_controller/subirDocumento/'.$id);?>" method="post" enctype="multipart/form-data">
      <input type="hidden" name="idmateria" value="<?= $id;?>">
     ...
     <br><br>
     <button class="btn my-2 my-sm-0 botonMio" style="background-color: #FF8000;" type="submit" value="submit" style="background-color: blue;">Subir Documento</button>
   </form>
 </div>
 <div class="container col-lg-4"></div>
</div>
